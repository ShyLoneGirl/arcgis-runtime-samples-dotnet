...
namespace ArcGISRuntime.UWP.Samples.ArcGISVectorTiledLayerUrl
{
    public partial class ArcGISVectorTiledLayerUrl
    {
        ...
        private void Initialize()
        {
            ...
            vectorLayersAndDataChooser.ItemsSource = _vectorLayerNames;

            // Assign the map to the MapView
            MyMapView.Map = myMap;
        }

        private void OnVectorLayersAndDataChooserSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
