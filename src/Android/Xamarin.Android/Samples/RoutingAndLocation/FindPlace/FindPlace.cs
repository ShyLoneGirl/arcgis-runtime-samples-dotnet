...
namespace ArcGISRuntimeXamarin.Samples.FindPlace
{
    ...
    public class FindPlace : Activity
    {
        ...
        private AutoCompleteTextView _myRoutingAndLocationBox;
        private AutoCompleteTextView _myLocationBox;
        private Button _myRoutingAndLocationButton;
        private Button _myRoutingAndLocationRestrictedButton;
        ...
        private void CreateLayout()
        {
            ...
            // RoutingAndLocation bar
            _myRoutingAndLocationBox = new AutoCompleteTextView(this) { Text = "Coffee" };
            layout.AddView(_myRoutingAndLocationBox);
            ...
            _myRoutingAndLocationBox.SetMaxLines(1);
            _myLocationBox.SetMaxLines(1);

            // RoutingAndLocation buttons; horizontal layout
            var searchButtonLayout = new LinearLayout(this) { Orientation = Orientation.Horizontal };
            _myRoutingAndLocationButton = new Button(this) { Text = "RoutingAndLocation All" };
            _myRoutingAndLocationRestrictedButton = new Button(this) { Text = "RoutingAndLocation View" };

            // Add the buttons to the layout
            searchButtonLayout.AddView(_myRoutingAndLocationButton);
            searchButtonLayout.AddView(_myRoutingAndLocationRestrictedButton);
            ...
            _myRoutingAndLocationBox.Enabled = false;
            _myLocationBox.Enabled = false;
            _myRoutingAndLocationButton.Enabled = false;
            _myRoutingAndLocationRestrictedButton.Enabled = false;

            // Hook up the UI event handlers for suggestion & search
            _myRoutingAndLocationBox.TextChanged += _myRoutingAndLocationBox_TextChanged;
            _myLocationBox.TextChanged += _myLocationBox_TextChanged;
            _myRoutingAndLocationButton.Click += _myRoutingAndLocationButton_Click;
            _myRoutingAndLocationRestrictedButton.Click += _myRoutingAndLocationRestrictedButton_Click;
        }
        ...
        private async Task UpdateRoutingAndLocation(string enteredText, string locationText, bool restrictToExtent = false)
        {
        ...
        /// </summary>
        private async void _myRoutingAndLocationBox_TextChanged(object sender, Android.Text.TextChangedEventArgs e)
        {
            ...
            // Apply the adapter
            _myRoutingAndLocationBox.Adapter = adapter;
        }
        ...
        /// </summary>
        private async void _myRoutingAndLocationButton_Click(object sender, EventArgs e)
        {
            // Get the search text
            string searchText = _myRoutingAndLocationBox.Text;
            ...
            // Run the search
            await UpdateRoutingAndLocation(searchText, locationText, false);
        }

        /// <summary>
        /// Method called to start a search that is restricted to results within the current extent
        /// </summary>
        private async void _myRoutingAndLocationRestrictedButton_Click(object sender, EventArgs e)
        {
            // Get the search text
            string searchText = _myRoutingAndLocationBox.Text;
            ...
            // Run the search
            await UpdateRoutingAndLocation(searchText, locationText, true);
        }
    }
}