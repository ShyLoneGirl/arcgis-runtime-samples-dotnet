    ...
    public partial class IdentifyKMLFeatures
    {
        ...
        private async void MyMapView_GeoViewTapped(object sender, GeoViewInputEventArgs e)
        {
            ...
            try
            {
                ...
                // Get the second item in the collection of layers (it should be the dynamic map image layer)
                ...
                //
                // TODO: Identify on KmlLayer is not yet implemented. The code from here on will need to be tweaked to
                // accommodate for KmlLayer specific issues: selection, highlight, callout/popup......
