...
namespace ArcGISRuntime.UWP.Samples.DisplayDeviceRoutingAndLocation
{
    public partial class DisplayDeviceRoutingAndLocation
    {
        ...
        private void OnRoutingAndLocationModesSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
