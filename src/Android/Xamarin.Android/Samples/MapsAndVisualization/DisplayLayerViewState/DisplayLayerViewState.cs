...
namespace ArcGISRuntimeXamarin.Samples.DisplayLayerViewState
{
    ...
    {
        // Create and hold reference to the used Map
        private MapView _myMap = new MapView();
        ...
        private void Initialize()
        {
            ...
            _myMap.LayerViewStateChanged += OnLayerViewStateChanged;

            // Provide used Map to the Map
            _myMap.Map = myMap;
        }

        private void OnLayerViewStateChanged(object sender, LayerViewStateChangedEventArgs e)
        {
            // For each execution of the Map.LayerViewStateChanged Event, get the name of
