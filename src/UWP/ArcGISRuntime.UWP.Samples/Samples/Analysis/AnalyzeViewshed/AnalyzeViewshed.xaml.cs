...
namespace ArcGISRuntime.UWP.Samples.AnalyzeViewshed
{
    public partial class AnalyzeViewshed 
    {
        ...
        private bool _isExecutingAnalysis;
        ...
        private async Task CalculateViewshed(MapPoint location)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    var message = new MessageDialog("Executing geoprocessing failed. " + myViewshedJob.Error.Message, "Analysis error");
        ...
        private void SetBusy(bool isBusy = true)
        {
            ...
            // sets the 'progress' control feedback status and updates the _isExecutingAnalysis
