...
namespace ArcGISRuntime.UWP.Samples.NetworkAnalysis
{
    public partial class NetworkAnalysis
    {
        ...
        private Uri _sanDiegoRouteServiceUri = new Uri("http://sampleserver6.arcgisonline.com/arcgis/rest/services/RoutingAndLocation/SanDiego/NAServer/Route");
