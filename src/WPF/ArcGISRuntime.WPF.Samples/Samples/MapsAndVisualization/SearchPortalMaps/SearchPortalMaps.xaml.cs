...
namespace ArcGISRuntime.WPF.Samples.SearchPortalMapsAndVisualizations
{
    public partial class SearchPortalMapsAndVisualizations
    {
        ...
        private async void SearchButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (SearchPublicMapsAndVisualizations.IsChecked == true)
            {
            ...
            MapsAndVisualizationListBox.ItemsSource = mapItems;
        }

        private void LoadMapsAndVisualizationButtonClick(object sender, RoutedEventArgs e)
        {
            // Get the selected web map item in the list box
            PortalItem selectedMapsAndVisualization = MapsAndVisualizationListBox.SelectedItem as PortalItem;
        ...
        private void WebMapsAndVisualizationLoadStatusChanged(object sender, Esri.ArcGISRuntime.LoadStatusEventArgs e)
        {
            ...
            if(status == Esri.ArcGISRuntime.LoadStatus.FailedToLoad)
            {
                ...
                if(err != null)
                {
                    MessageBox.Show(err.Message, "MapsAndVisualization Load Error");
                }
            }
        }
        ...
        private void RadioButtonUnchecked(object sender, RoutedEventArgs e)
        {
            ...
            MapsAndVisualizationListBox.ItemsSource = null;

            // Set the map to the default (if necessary)
            if (MyMapsAndVisualizationView.MapsAndVisualization.Item != null)
            {
                DisplayDefaultMapsAndVisualization();
            }
        }
        ...
        private void CancelOAuthSettingsClicked(object sender, RoutedEventArgs e)
        {
            ...
            if (noAuth)
            {
                ...
                BrowseMyMapsAndVisualizations.IsEnabled = false;
