...
namespace ArcGISRuntimeXamarin.Samples.ArcGISVectorTiledLayerUrl
{
    ...
    public class ArcGISVectorTiledLayerUrl : Activity
    {
        ...
        private void OnVectorLayersAndDataClicked(object sender, EventArgs e)
        {
            var button = sender as Button;

            // Create menu to show options
            var menu = new PopupMenu(this, button);
            menu.MenuItemClick += OnVectorLayersAndDataMenuItemClicked;
        ...
        private void OnVectorLayersAndDataMenuItemClicked(object sender, PopupMenu.MenuItemClickEventArgs e)
        {
        ...
        private void CreateLayout()
        {
            ...
            button.Click += OnVectorLayersAndDataClicked;
