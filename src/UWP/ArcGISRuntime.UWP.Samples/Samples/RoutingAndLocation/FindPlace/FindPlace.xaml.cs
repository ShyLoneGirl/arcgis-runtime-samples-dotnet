...
namespace ArcGISRuntime.UWP.Samples.FindPlace
{
    public partial class FindPlace
    {
        ...
        /// </summary>
        private async void MyRoutingAndLocationBox_TextChanged(AutoSuggestBox sender, AutoSuggestBoxTextChangedEventArgs args)
        {
            ...
            MyRoutingAndLocationBox.ItemsSource = results;
        }
        ...
        /// </summary>
        private void MyRoutingAndLocationRestrictedButton_Click(object sender, RoutedEventArgs e)
        {
            // Get the search text
            string searchText = MyRoutingAndLocationBox.Text;
        ...
        /// </summary>
        private void MyRoutingAndLocationButton_Click(object sender, RoutedEventArgs e)
        {
            // Get the search text
            string searchText = MyRoutingAndLocationBox.Text;
