...
namespace ArcGISRuntime.UWP.Samples.EditAndSyncFeatures
{
    public partial class EditAndSyncFeatures
    {
        ...
        private async void Initialize()
        {
            ...
            string uwpFolder = Windows.Storage.ApplicationLayersAndData.Current.LocalFolder.Path.ToString();
        ...
        private async Task<string> GetTpkPath()
        {
            ...
            // Get the full path
            string filepath = Path.Combine(folder, "SampleLayersAndData", "EditAndSyncFeatures", filename);

            // Check if the file exists
            if (!File.Exists(filepath))
            {
                // Download the map package file
                await LayersAndDataManager.GetLayersAndData("3f1bbf0ec70b409a975f5c91f363fe7d", "EditAndSyncFeatures");
            }
            return filepath;
