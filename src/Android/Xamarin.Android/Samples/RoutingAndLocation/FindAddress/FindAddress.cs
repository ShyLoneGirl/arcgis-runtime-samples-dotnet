...
namespace ArcGISRuntimeXamarin.Samples.FindAddress
{
    ...
    public class FindAddress : Activity
    {
        ...
        private EditText _addressRoutingAndLocationBar;
        ...
        private async void Initialize()
        {
            ...
            _addressRoutingAndLocationBar.Enabled = true;
        ...
        private void CreateLayout()
        {
            ...
            // Add the search bar
            _addressRoutingAndLocationBar = new EditText(this);

            layout.AddView(searchBarLayout);
            searchBarLayout.AddView(_addressRoutingAndLocationBar);
            // Add a search button
            _searchButton = new Button(this) { Text = "RoutingAndLocation" };
        ...
        private void RoutingAndLocationButton_Click(object sender, EventArgs e)
        {
            updateRoutingAndLocation();
        }
