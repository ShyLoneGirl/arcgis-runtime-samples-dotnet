...
namespace ArcGISRuntime.UWP.Samples.SetMapsAndVisualizationSpatialReference
{
    public partial class SetMapsAndVisualizationSpatialReference
    {
        ...
        private void Initialize()
        {
            ...
            ArcGISMapsAndVisualizationImageLayer operationalLayer = new ArcGISMapsAndVisualizationImageLayer(new Uri(
                "http://sampleserver6.arcgisonline.com/arcgis/rest/services/SampleWorldCities/MapsAndVisualizationServer"));
