...
namespace ArcGISRuntimeXamarin.Samples.FindPlace
{
    ...
    public class FindPlace : UIViewController
    {
        ...
        private UITextField _myRoutingAndLocationBox = new UITextField();

        // Create the location search box
        private UITextField _myLocationBox = new UITextField();

        // Create the unrestricted search button
        private UIButton _myRoutingAndLocationButton = new UIButton();

        // Create the restricted search button
        private UIButton _myRoutingAndLocationRestrictedButton = new UIButton();
        ...
        private bool _locationRoutingAndLocationActive = false;
        ...
        public override void ViewDidLayoutSubviews()
        {
            ...
            _myRoutingAndLocationBox.Frame = new CoreGraphics.CGRect(margin, (topHeight += margin), width, height);
            ...
            _myRoutingAndLocationButton.Frame = new CoreGraphics.CGRect(margin, (topHeight += margin + height), halfWidth, height);

            // The search restricted button takes up half the width in the third row
            _myRoutingAndLocationRestrictedButton.Frame = new CoreGraphics.CGRect(halfWidth + 3 * margin, topHeight, halfWidth, height);
		...
		private void CreateLayout()
        {
            ...
            _myRoutingAndLocationButton.SetTitle("RoutingAndLocation All", UIControlState.Normal);
            _myRoutingAndLocationRestrictedButton.SetTitle("RoutingAndLocation in View", UIControlState.Normal);

            // Set the default location and search text
            _myLocationBox.Text = "Current Location";
            _myRoutingAndLocationBox.Text = "Coffee";

            // Gray out the buttons when they are disabled
            _myRoutingAndLocationButton.SetTitleColor(UIColor.Gray, UIControlState.Disabled);
            _myRoutingAndLocationRestrictedButton.SetTitleColor(UIColor.Gray, UIControlState.Disabled);

            // Change button color when enabled
            _myRoutingAndLocationButton.SetTitleColor(UIColor.Blue, UIControlState.Normal);
            _myRoutingAndLocationRestrictedButton.SetTitleColor(UIColor.Blue, UIControlState.Normal);

            // Color the textboxes and buttons to appear over the mapview
            UIColor background = UIColor.FromWhiteAlpha(.85f, .95f);
            _myRoutingAndLocationBox.BackgroundColor = background;
            _myLocationBox.BackgroundColor = background;
            _myRoutingAndLocationButton.BackgroundColor = background;
            _myRoutingAndLocationRestrictedButton.BackgroundColor = background;
            ...
            _myRoutingAndLocationRestrictedButton.Layer.CornerRadius = 5;
            _myRoutingAndLocationButton.Layer.CornerRadius = 5;
            _myLocationBox.Layer.CornerRadius = 5;
            _myRoutingAndLocationBox.Layer.CornerRadius = 5;
            ...
            _myRoutingAndLocationButton.TouchUpInside += _myRoutingAndLocationButton_Clicked;
            _myRoutingAndLocationRestrictedButton.TouchUpInside += _myRoutingAndLocationRestrictedButton_Click;

            // Listen for text-changed events
            _myRoutingAndLocationBox.AllEditingEvents += _myRoutingAndLocationBox_TextChanged;
            _myLocationBox.AllEditingEvents += _myLocationBox_TextChanged;

            // Add the views
            View.AddSubviews(_myMapView, _myRoutingAndLocationBox, _myLocationBox, _myRoutingAndLocationButton, _myRoutingAndLocationRestrictedButton, _myProgressBar, _mySuggestionView);
        }
        ...
        private async void Initialize()
        {
            ...
            _myRoutingAndLocationBox.Enabled = true;
            _myRoutingAndLocationButton.Enabled = true;
            _myRoutingAndLocationRestrictedButton.Enabled = true;
        }
        ...
        private async void _myLocationBox_TextChanged(object sender, EventArgs e)
        {
            ...
            _locationRoutingAndLocationActive = true;
        ...
        /// </summary>
        private async void _myRoutingAndLocationBox_TextChanged(object sender, EventArgs e)
        {
            // Set the currently-updated text field
            _locationRoutingAndLocationActive = false;

            // Get the current text
            string searchText = _myRoutingAndLocationBox.Text;
        ...
        /// </summary>
        private void _myRoutingAndLocationRestrictedButton_Click(object sender, EventArgs e)
        {
            // Get the search text
            string searchText = _myRoutingAndLocationBox.Text;
        ...
        /// </summary>
        private void _myRoutingAndLocationButton_Clicked(object sender, EventArgs e)
        {
            // Get the search text
            string searchText = _myRoutingAndLocationBox.Text;
        ...
        public void AcceptSuggestion(string text)
        {
            ...
            if (_locationRoutingAndLocationActive)
            {
                _myLocationBox.Text = text;
            }
            else
            {
                _myRoutingAndLocationBox.Text = text;
            }
