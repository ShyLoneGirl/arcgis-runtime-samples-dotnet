...
namespace ArcGISRuntime.WPF.Samples.AuthorMapsAndVisualization
{
    public partial class AuthorMapsAndVisualization
    {
        ...
        private void SaveOAuthSettingsClicked(object sender, RoutedEventArgs e)
        {
            ...
            SaveMapsAndVisualizationGrid.Visibility = Visibility.Visible;
        ...
        private async void SaveMapsAndVisualizationClicked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (myMapsAndVisualization.Item == null)
                {
                    ...
                    await SaveNewMapsAndVisualizationAsync(MyMapsAndVisualizationView.MapsAndVisualization, title, description, tags, thumbnailImg);

                    // Report a successful save
                    MessageBox.Show("Saved '" + title + "' to ArcGIS Online!", "MapsAndVisualization Saved");
                }
                else
                {
                    ...
                    MessageBox.Show("Saved changes to '" + myMapsAndVisualization.Item.Title + "'", "Updates Saved");
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task SaveNewMapsAndVisualizationAsync(MapsAndVisualization myMapsAndVisualization, string title, string description, string[] tags, RuntimeImage thumb)
        {
            ...
            await myMapsAndVisualization.SaveAsAsync(agsOnline, null, title, description, tags, thumb);                      
        }
