...
namespace ArcGISRuntime.UWP.Samples.FindAddress
{
    public partial class FindAddress
    {
        ...
        private async void Initialize()
        {
            ...
            MyAppBarRoutingAndLocationButton.IsEnabled = true;
            MyAppBarSuggestButton.IsEnabled = true;
        }

        private void RoutingAndLocationButton_Click(object sender, RoutedEventArgs e)
        {
        ...
        private async void UpdateRoutingAndLocation()
        {
            ...
            String enteredText = MyRoutingAndLocationBox.Text;
        ...
        private void OnSuggestionChosen(object sender, RoutedEventArgs e)
        {
            ...
            // Update the search
            MyRoutingAndLocationBox.Text = selectedItem.Text;
            UpdateRoutingAndLocation();
        }
